...
export default function BeneficiaryStepTop({
  ...
  return (
    isActive && (
      <>
        <div className="h-full flex flex-row items-center mx-auto mt-4 md:mt-8 xl:mt-10 2xl:mt-14">
        ...
        <p className="text-sm font-semibold mx-auto text-center w-11/12 md:w-1/2 base:w-1/3 mt-4 md:mt-8 2xl:mt-12">
